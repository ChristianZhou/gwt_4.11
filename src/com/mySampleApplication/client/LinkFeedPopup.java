...
public class LinkFeedPopup extends Popup {
    ...
    protected void onRender(Element parent, int pos) {
        ...
        final BorderLayoutData northData = new BorderLayoutData(Style.LayoutRegion.NORTH, 20);
        ...
        final BorderLayoutData eastData = new BorderLayoutData(Style.LayoutRegion.EAST, 50);
